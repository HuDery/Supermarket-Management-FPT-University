            ...
            if (session != null) {
                ...
                if (cart != null) {
                    if (cart.getCart().containsKey(productID)) {
                        if (newQuantity > Integer.parseInt(request.getParameter("quantity"))) {
                            String message = "So luong cua san pham nay chi con " + Integer.parseInt(request.getParameter("quantity"));

...
public class AddController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductDTO product = new ProductDTO(productID, productName, image, price, quantity_add, categoryID, importDate, usingDate);
            ...
            if(quantity_add > Integer.parseInt(request.getParameter("quantity"))){
                request.setAttribute("MESSAGE", "Only have "+ Integer.parseInt(request.getParameter("quantity")) +" "+ productName +" in shop");
                url= SUCCESS;
            }else{
                cart.add(product);
                session.setAttribute("CART", cart);
                request.setAttribute("MESSAGE",""+ quantity_add +" "+ productName +" added to cart");
                url = SUCCESS;
            }
        }catch (Exception e) {
